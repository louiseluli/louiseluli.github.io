...
function activateEasterEgg() {
    ...
    console.log('🎉 You found the Easter egg! Louise appreciates your curiosity!');
}
...
document.querySelectorAll('.project-link, .feature-link').forEach(link => {
    link.addEventListener('click', (e) => {
        if (link.getAttribute('href') === '#') {
            e.preventDefault();
            alert('This project page is coming soon! Stay tuned for detailed documentation and live demos.');
        }
    });
});
...
console.log('%cThis website was built with love by Louise Ferreira', 'font-size: 14px; color: #CBD5E1;');
console.log('%cTech stack: HTML, CSS, JavaScript, Python', 'font-size: 12px; color: #94A3B8;');
console.log('%cInterested in collaboration? Reach out at louisesfer@gmail.com', 'font-size: 12px; color: #10B981;');
